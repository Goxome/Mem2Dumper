...
void Usage() {
  ...
  printf ("\n \n");
  printf ("\n \n");
  printf ("                                           <<   Memory2Dumper   >>  \n");
  printf("                                     Mem2Dumper | Made By Goxome");
  printf("                \n");
    printf("                        --------------------------------------------------------------------------\n");
	printf ("\n\n");
   ...
   printf("- Example ----------------------------------------------------------------------------------------------\n");
    ...
    printf("Usage: ./Mem2Dumper -p <packageName> <option(s)>\n");
    printf("Usage Example: >> ./Mem2Dumper -p com.goxome.demo -l -n libGoxome.so -o /sdcard << \n");
    printf ("\n");

  
    printf("- Guide Examples -----------------------------------------------------------------------------------\n");
	...
	printf(" Options:\n");
	printf("- Auto Dump Arguments -------------------------------------------------------------------------\n");
	printf("  -n --name <segment_name>          Segment Name From proc maps\n");
    printf ("\n");
	printf("- Manual Dump Arguments ---------------------------------------------------------------------\n");
...
int main(int argc, char *argv[]) {
    ...
    if(!isValidArg || name.empty() || outputpath.empty()) {
        ...
        printf("Contact: GoxomeOfficial@gmail.com \n");
        Usage();
        return -1;
    }
    ...
    if(isManualDump){
        ...
        if(isRawDump){
            ...
            string tempPath = outputpath + "/GTemp.dat";
            ...
            redump.close();
#endif
            cout << "Rebuilding Completed Successfully" << endl;
